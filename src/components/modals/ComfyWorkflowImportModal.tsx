    ...
    <div className="space-y-5">
      ...
      <section className="space-y-1.5">
        ...
        <p className="text-xs text-neutral-400 leading-relaxed">
          ...
          of the graph. Candora Art keeps those selections, so the node arrives ready to run.
        </p>
        <p className="text-xs text-neutral-400 leading-relaxed">
          Without App Mode, Candora Art finds the inputs and the outputs itself. You confirm them
