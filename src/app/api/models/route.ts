...
const KIE_MODELS: ProviderModel[] = [
  ...
  },
  {
    ...
    name: "GPT Image 2",
    description: "GPT Image 2 via Kie.ai. High-quality generation with 1K/2K/4K. Connect a reference image to run image-to-image (up to 16 images).",
    provider: "kie",
    capabilities: ["text-to-image", "image-to-image"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/gpt-image-2",
  },
  {
    id: "gpt-image-2-image-to-image",
    name: "GPT Image 2 Edit",
    description: "GPT Image 2 image-to-image via Kie.ai. Supports up to 16 reference images.",
    provider: "kie",
    capabilities: ["image-to-image"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/gpt-image-2",
  },
  {
    ...
    description: "Qwen Image 3.0 Pro via Kie.ai. Dense layouts, small text, and 1K/2K. Connect a reference image to run image-to-image (up to 3 images).",
    provider: "kie",
    capabilities: ["text-to-image", "image-to-image"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/qwen-image-3",
  },
  {
    id: "qwen3/pro-image-to-image",
    name: "Qwen Image 3.0 Pro Edit",
    description: "Qwen Image 3.0 Pro image-to-image via Kie.ai. Supports up to 3 reference images.",
    provider: "kie",
    capabilities: ["image-to-image"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/qwen-image-3",
  },
  {
    ...
    name: "Qwen Image 3.0",
    description: "Qwen Image 3.0 via Kie.ai. Faster 3.0 generation at 1K/2K. Connect a reference image to run image-to-image (up to 3 images).",
    provider: "kie",
    capabilities: ["text-to-image", "image-to-image"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/qwen-image-3",
  },
  {
    ...
    description: "Qwen Image 3.0 image-to-image via Kie.ai. Supports up to 3 reference images.",
    provider: "kie",
    capabilities: ["image-to-image"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/qwen-image-3",
